...
function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: `Hey there, sugar! 🍭✨ Welcome to the Sugar Terminal! I'm your sweet AI companion powered by ${isOpenAIConfigured() ? 'the latest GPT-4 magic' : 'pure sugar crystals'}! Ready to chat about anything your sweet heart desires! What's cooking in your wonderful world today? 💖`,
      isUser: false,
      timestamp: new Date()
    }
  ]);
